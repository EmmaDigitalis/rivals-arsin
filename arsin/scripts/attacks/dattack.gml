...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 132 - 92);
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, 121 - 144);
...
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, .50);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_X, 160 - 92);
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, 120 - 144);
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 16);
...
set_hitbox_value(AT_DATTACK, 2, HG_DAMAGE, 23);
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 38);
...
set_hitbox_value(AT_DATTACK, 2, HG_DRIFT_MULTIPLIER, 0.5);
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, .3);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, HFX_GEN_SWEET);
