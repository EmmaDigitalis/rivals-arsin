...
set_hitbox_value(AT_JAB, 1, HG_HITBOX_X, 125 - 92);
set_hitbox_value(AT_JAB, 1, HG_HITBOX_Y, 107 - 144);
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, HFX_GEN_DIR);
...
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, 112 - 92);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, 111 - 144);
...
set_hitbox_value(AT_JAB, 2, HG_HITSTUN_MULTIPLIER, 1.4);
...
set_hitbox_value(AT_JAB, 3, HG_HITBOX_X, 118 - 92);
set_hitbox_value(AT_JAB, 3, HG_HITBOX_Y, 99 - 144);
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 63);
...
set_hitbox_value(AT_JAB, 3, HG_FINAL_BASE_KNOCKBACK, 12);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, HFX_GEN_BIG);
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, 118 - 92);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, 105 - 144);
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 72);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 82);
...
set_hitbox_value(AT_JAB, 4, HG_HITSTUN_MULTIPLIER, 1.4);
...
set_hitbox_value(AT_JAB, 4, HG_VISUAL_EFFECT, hfx_none);
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("sfx_hit_slash1"));
